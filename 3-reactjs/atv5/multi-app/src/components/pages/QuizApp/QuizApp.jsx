...
const Container = styled.div`
  ...
  background: #000; // Define o fundo como branco.
...
const Question = styled.p`
  color: wheat; // Define a cor do texto como um tom médio de cinza.
...
const OptionButton = styled.button`
  ...
  &:active { // Aplica estilos ao botão quando ele é clicado.
    background-color: gray; // Muda a cor de fundo para um tom ainda mais escuro de azul.
...
const QuizApp = () => {
  ...
  return (
    <Container>
      ...
      {currentQuestion < quiz.questions.length ? ( // Verifica se ainda há perguntas para responder.
        <div>
          <Question>{quiz.questions[currentQuestion].question}</Question> {/* Exibe a pergunta atual */}
