...
const Login = ({ onLogin }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (user) {
      onLogin(); // Chama a função onLogin passada como prop se o usuário existir no JSON
    } else {
      toast.error('Usuário não encontrado!'); // Exibe um alerta se o usuário não for encontrado
    }
  };
